...
////  MenuBar.swift
////  HereAndThere
////  Created by Winston Maragh on 1/25/18.
...
//		button1.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor).isActive = true
//		button1.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor).isActive = true
//		button1.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor).isActive = true
//		button1.widthAnchor.constraint(equalTo: safeAreaLayoutGuide.widthAnchor, multiplier: 0.2).isActive = true
//	}
//	func addButton2(){
//		addSubview(button2)
...
//		button4.leadingAnchor.constraint(equalTo: button3.trailingAnchor).isActive = true
